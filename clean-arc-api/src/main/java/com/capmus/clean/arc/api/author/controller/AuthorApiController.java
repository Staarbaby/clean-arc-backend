package com.capmus.clean.arc.api.author.controller;
...
import com.campus.clean.arc.domain.author.usecase.ChangePasswordUseCase;
import com.capmus.clean.arc.api.author.dto.request.AuthorEditRequest;
import com.capmus.clean.arc.api.author.dto.request.ChangePasswordRequest;
import com.capmus.clean.arc.api.author.dto.request.RegistrationRequest;
import com.capmus.clean.arc.api.author.dto.response.AuthorResponse;
import com.capmus.clean.arc.api.author.mapper.AuthorMapper;
import com.capmus.clean.arc.api.author.routes.AuthorRoutes;
import com.capmus.clean.arc.api.commons.utils.CredentialUtils;
...
public class AuthorApiController {
    ...
    @Operation(summary = "Change password foe current author")
    @PutMapping(value = AuthorRoutes.CHANGE_PASSWORD, produces = {MediaType.APPLICATION_JSON_VALUE})
    public SuccessApiResponse<AuthorResponse> editById(
