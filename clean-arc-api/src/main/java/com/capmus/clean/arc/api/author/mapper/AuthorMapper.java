package com.capmus.clean.arc.api.author.mapper;
...
import com.campus.clean.arc.domain.author.usecase.CreateAuthorUserCase;
import com.campus.clean.arc.domain.author.usecase.UpdateAuthorUseCase;
...
public class AuthorMapper {
    ...
    public static CreateAuthorUserCase.InputValues map(RegistrationRequest item){
        return CreateAuthorUserCase.InputValues.of(item.getEmail(), item.getPassword(), item.getFirstName(), item.getLastName());
